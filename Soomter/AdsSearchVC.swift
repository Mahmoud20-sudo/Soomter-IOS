...
class AdsSearchVC: UIViewController, UITableViewDelegate, UITableViewDataSource{
...
//            }
        ...
        var totalHeight = catgs_tv.contentSize.height + ads_types_tv.contentSize.height + cities_tv.contentSize.height
        scrollview.contentSize = CGSize(width: scrollview.contentSize.width , height: totalHeight + 100)
    }
