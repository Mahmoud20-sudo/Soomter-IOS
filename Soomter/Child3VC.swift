...
class Child3VC: UIViewController , IndicatorInfoProvider , UICollectionViewDelegate, UICollectionViewDataSource , UICollectionViewDelegateFlowLayout{
    ...
    func indicatorInfo(for pagerTabStripController: PagerTabStripViewController) -> IndicatorInfo {
        return IndicatorInfo(title: Bundle.main.localizedString(forKey: "video-ads", value: nil, table: "Default"))
    }
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        adsDetailsVC.adObject = adsData?.VideoAds?[indexPath.row]
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        //print(adsData?.VideoAds?[indexPath.row].Title)
        cell.config(_Obj: (adsData?.VideoAds?[indexPath.row])!)
