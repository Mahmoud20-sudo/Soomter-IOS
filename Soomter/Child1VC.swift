...
class Child1VC: UIViewController , IndicatorInfoProvider , UICollectionViewDelegate, UICollectionViewDataSource , UICollectionViewDelegateFlowLayout{
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        ...
        if (adsData?.PromotedAds?.count)! > 3 {
    ...
    func indicatorInfo(for pagerTabStripController: PagerTabStripViewController) -> IndicatorInfo {
        return IndicatorInfo(title: Bundle.main.localizedString(forKey: "the-special-ads", value: nil, table: "Default"))
    }
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        adsDetailsVC.adObject = adsData?.PromotedAds?[indexPath.row]
    ...
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return (adsData?.PromotedAds?.count)!
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.config(_Obj: (adsData?.PromotedAds?[indexPath.row])!)
