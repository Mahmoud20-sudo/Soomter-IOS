...
class Child4VC: UIViewController , IndicatorInfoProvider , UICollectionViewDelegate, UICollectionViewDataSource , UICollectionViewDelegateFlowLayout{
    ...
    func indicatorInfo(for pagerTabStripController: PagerTabStripViewController) -> IndicatorInfo {
        return IndicatorInfo(title: Bundle.main.localizedString(forKey: "text-ads", value: nil, table: "Default"))
    }
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        adsDetailsVC.adObject = adsData?.TextAds?[indexPath.row]
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        //print(adsData?.TextAds?[indexPath.row].Title)
        cell.config(_Obj: (adsData?.TextAds?[indexPath.row])!)
        if Locale.preferredLanguages[0] == "en"{
